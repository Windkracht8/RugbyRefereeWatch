...
public class Filestore {
    ...
    //Store all merchants
    public static void file_storeMatches(Context context, ArrayList<matchdata> matches){
        try {
    ...
    public static void file_deletedMatches(Context context, String requestdata){
        //TODO: this
    }
